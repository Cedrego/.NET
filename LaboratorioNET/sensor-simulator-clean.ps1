...
# Clean PowerShell simulator for /api/sensor
# Usage:
#   .\sensor-simulator-clean.ps1 -CarreraId "test-carrera" -CorredoresIds @("1001","1002") -CantSecciones 3 -Url "https://localhost:7263" -DelayMs 500
